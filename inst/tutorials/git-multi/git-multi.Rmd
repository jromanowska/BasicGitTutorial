...
2. **all members of the group** need to clone this repo
...
> Remember that branches are short-lived, so create a name that has to do with
> a function or an action that you will code.
...
- create an R project connected to GitHub repo
- commit changes and inspect the history online
- collaborate on coding online
- resolve merge conflicts
- work in branches and create pull requests

> `r fa("medal")` Congratulations! You're ready to use
